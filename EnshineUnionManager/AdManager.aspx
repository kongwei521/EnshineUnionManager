<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdManager.aspx.cs" Inherits="EnshineUnionManager.AdManager" %>
						 ...
						 <uc1:MenuList runat="server" id="MenuList" />
							...
							<section id="main" class="clearfix">
								<div id="main-header" class="page-header">
									...
									<h1>
										<i class="icon-list"></i>广告信息一览 <span>This is the place where Search Result started</span>
									</h1>	
								</div>
								<!--库存余量查询数据一览内容-->
								<div id="main-content">
													   ...
													   <div class='widget-header'>
															<span class='title'>
																 <i class='icol-blog'></i>广告信息管理
																		   ...
																		   <input type='button' class='btn  btn-primary'  value='新广告添加' 
																						onclick="window.location.href = 'NewAdAdd.aspx?mid=<%=Request["mid"]%>'" />  
            </div>
