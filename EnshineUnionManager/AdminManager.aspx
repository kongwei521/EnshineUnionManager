<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminManager.aspx.cs" Inherits="EnshineUnionManager.AdminManager" %>
                                            ...
                                            <div class='row-fluid'>
                                                <div class='span12 widget'>
                                                    <div class='widget-header'>
                                                        <span class='title'>
                                                            <i class='icol-blog'></i>管理员信息管理
                                                        </span>
                                                        <div style='float: right; padding-top: 4px; padding-right: 4px;'>
                                                            <input type='button' class='btn  btn-primary' value='管理员添加'
                                                                onclick="window.location.href = 'AdminEditInfo.aspx?mid=<%=Request["mid"]%>'" />
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class='row-fluid' style='padding-top: 2px;'>
                                                            <div class='span12 section divScrool'>
                                                                <table class='table table-bordered table-striped'>
																		   ...
																		   <tbody id="divShowAdminInfoManager">
																		   </tbody>
																	  </table>
                                                            </div>
                                                        </div>
