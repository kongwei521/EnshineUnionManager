<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CoCheckExport.aspx.cs" Inherits="EnshineUnionManager.CoCheckExport" %>
                        ...
                        <div id="content-inner">
									...
									<ul>
										...
										<li class="active">
											...
											<ul class="inner-nav">
												...
												<li class="active"><a href="CoCheckExport.aspx"><i class="icol-accept"></i>厂家核对报表</a></li>
                            ...
                            <section id="main" class="clearfix">
                                <div id="main-header" class="page-header">
                                        ...
                                        <li>
                                            <a href="#">益生联盟数据平台 Web Client Search</a>
																																	...
																																	<div class="widget-box">
																																		<h1>
																																			<i class="icon-zoom-in"></i>厂家核对报表查询 <span>This is the place where Search started</span>
																																		</h1>
																																		<br />
																																			...
																																			<table class="table table-bordered table-striped" style="width: 80%; margin: 0 auto">
																																				...
																																				<tbody>
																																					...
																																					<tr class="odd gradeC">
																																						<td>县域门店：</td>
																																						<td>
																																							<asp:DropDownList ID="drpShopSet" runat="server"></asp:DropDownList></td>
																																						<td rowspan="2">
																																							<input type="button" class="btn btn-info" id="btnSearch" value="查询" />&nbsp;&nbsp;&nbsp;&nbsp;
                                                            <input type="button" class="btn btn-info" id="btnReset" runat="server"	value="清除" />
																																						</td>
																																					</tr>
																																					<tr class="odd gradeX">
																																						<td>时间选择：</td>
                                    ...
                                    <h1>
                                        <i class="icon-list"></i>厂家核对报表一览   <span>This is the place where Search Result started</span>
                                    </h1>
                                </div>
                                <!--库存余量查询数据一览内容-->
                                <div id="main-content">
                                            ...
                                            <div class='row-fluid'>
                                                <div class='span12 widget'>
                                                    <div class='widget-header'>
                                                        <span class='title'>
                                                            <i class='icol-blog'></i>厂家核对报表管理					
                                                        </span>
                                                        <div style='float: right; padding-top: 4px; padding-right: 4px;'>
                                                            
                                                             		 <input type='button' class='btn  btn-primary' runat="server"  	 value='导出Excel' 
															...
															<div class='row-fluid' style='padding-top: 2px; '>
																 <div class='span12 section divScrool'>
																	  <table class='table table-bordered table-striped'>
																		   ...
																		   <tbody id="divShowSaleCheckReport">
																		   </tbody>
																	  </table>
																 </div>
															</div>
