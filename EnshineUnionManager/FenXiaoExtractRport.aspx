<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FenXiaoExtractRport.aspx.cs" Inherits="EnshineUnionManager.FenXiaoExtractRport" %>
                                ...
                                <div id="main-header" class="page-header">
                                    <ul class="breadcrumb">
                                       ...
                                       <div class="widget-box">
                                        <h1>
                                            <i class="icon-zoom-in"></i>分销提成报表查询 <span>This is the place where Search started</span>
                                        </h1>
                                        <br />
                                    ...
                                    <h1>
                                        <i class="icon-list"></i>分销提成报表一览 <span>This is the place where Search Result started</span>
                                    </h1>
                                </div>
                                <!--库存余量查询数据一览内容-->
                                <div id="main-content">
