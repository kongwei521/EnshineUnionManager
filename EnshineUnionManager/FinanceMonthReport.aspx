<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinanceMonthReport.aspx.cs" Inherits="EnshineUnionManager.FinanceMonthReport" %>
                            ...
                            <section id="main" class="clearfix">
                                <div id="main-header" class="page-header">
                                    ...
                                    <div class="widget-box">
                                        <h1>
                                            <i class="icon-zoom-in"></i>月销售统计查询 <span>This is the place where Search started</span>
                                        </h1>
                                        <br />
                                    ...
                                    <h1>
                                        <i class="icon-list"></i>月销售统计一览 <span>This is the place where Search Result started</span>
                                    </h1>
                                </div>
                                <!--库存余量查询数据一览内容-->
                                <div id="main-content">
                                            ...
                                            <div class='row-fluid'>
                                                <div class='span12 widget'>
                                                    <div class='widget-header'>
                                                        <span class='title'>
                                                            <i class='icol-blog'></i>月销售统计信息管理					
                                                        </span>
                                                        <div style='float: right; padding-top: 4px; padding-right: 4px;'>
                                                            
                                                             		 <input type='button' class='btn  btn-primary' runat="server"
																																																																	 onserverclick="btnExportExcel_ServerClick"  	 value='导出Excel' 
																				 id="btnExportExcel"		 />   
                                                        </div>
