<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodAreaSalesTotal.aspx.cs" Inherits="EnshineUnionManager.GoodAreaSalesTotal" %>
						...
						<div id="content-inner">
							...
							<section id="main" class="clearfix">
								<div id="main-header" class="page-header">
									...
									<h1>
										<i class="icon-list"></i>地区消费排行榜信息一览 <span>This is the place where Search Result started</span>
									</h1>	
								</div>
								<!--库存余量查询数据一览内容-->
								<div id="main-content">
											 ...
											 <div class='row-fluid'>
												  <div class='span12 widget'>
													   <div class='widget-header'>
															<span class='title'>
																 <i class='icol-blog'></i>地区消费排行榜信息统计
															</span>
															...
															<div class='row-fluid' style='padding-top: 2px;'>
																 <div class='span12 section divScrool'>
																	  <table class='table table-bordered table-striped'>
																		   ...
																		   <tbody id="divShowGoodAreaSalesTotalManager">
																		   </tbody>
																	  </table>
																 </div>
															</div>
