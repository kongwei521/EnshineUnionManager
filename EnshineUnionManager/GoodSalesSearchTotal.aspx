<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodSalesSearchTotal.aspx.cs" Inherits="EnshineUnionManager.GoodSalesSearchTotal" %>
															...
															<div class='row-fluid' style='padding-top: 2px;'>
																 <div class='span12 section divScrool'>
																	  <table class='table table-bordered table-striped'>
																		   ...
																		   <tbody id="divShowGoodSalesSearchTotalManager">
																		   </tbody>
																	  </table>
																 </div>
															</div>
