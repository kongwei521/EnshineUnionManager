<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodSalesTotal.aspx.cs" Inherits="EnshineUnionManager.GoodSalesTotal" %>
															...
															<div class='row-fluid' style='padding-top: 2px;'>
																 <div class='span12 section divScrool'>
																	  <table class='table table-bordered table-striped'>
																		   ...
																		   <tbody id="divShowGoodSalesTotalManager">
																		   </tbody>
																	  </table>
																 </div>
															</div>
