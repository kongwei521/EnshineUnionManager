<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsInWareHouse.aspx.cs" Inherits="EnshineUnionManager.GoodsInWareHouse" %>
							...
							<section id="main" class="clearfix">
								<div id="main-header" class="page-header">
									...
									<div class="widget-box">
										<h1>
											<i class="icon-zoom-in"></i>入库商品查询 <span>This is the place where Search started</span>
										</h1>
										<br />
												...
												<tbody>
													...
													<tr class="odd gradeC">
														...
														<td>
															...
															<input id="txtExpireDate" runat="server" width="200" class="text-info" type="text" /></td>
									...
									<h1>
										<i class="icon-list"></i>入库商品管理信息一览 <span>This is the place where Search Result started</span>
									</h1>
								</div>
								<!--库存余量查询数据一览内容-->
								<div id="main-content">
														...
														<div class='row-fluid' style='padding-top: 2px;'>
															<div class='span12 section divScrool'>
																<table class='table table-bordered table-striped'>
																	...
																	<tbody id="divShowGoodsInWhManager">
																	</tbody>
																</table>
															</div>
														</div>
