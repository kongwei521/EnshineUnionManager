<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsPackageAdd.aspx.cs" ValidateRequest="false" Inherits="EnshineUnionManager.GoodsPackageAdd" %>
                            ...
                            <section id="main" class="clearfix">
                                <div id="main-header" class="page-header">
                                    ...
                                    <div class="widget-box">
                                        <h1>
                                            <i class="icon-zoom-in"></i>套餐商品信息添加 <span>This is the place where Search started</span>
                                        </h1>
                                        <br />
                                            ...
                                            <div class='row-fluid'>
                                                <div class='span12 widget'>
                                                    <div class='widget-header'>
                                                        <span class='title'>
                                                            <i class='icol-blog'></i>套餐商品信息管理
                                                        </span>
                                                        <div style='float: right; padding-top: 4px; padding-right: 4px;'>
                                                            <input type='button' class='btn  btn-primary' value='套餐商品列表管理'
                                                                onclick="window.location.href = 'GoodsPackageManager.aspx?mid=<%=Request["mid"]%>'" />
                                                        </div>
                                                    </div>
                                                        ...
                                                        <table class='table table-bordered table-striped'>
                                                            ...
                                                            <tbody>
                                                                <tr class="even gradeC">
                                                                    <td style="width: 120px;">套餐商品标题：</td>
                                                                ...
                                                                <tr class="even gradeX">
                                                                    <td>套餐商品分类/<br />是否生效/首页显示：</td>
                                                                    <td style="text-align: left">
                                                                             <asp:DropDownList ID="drpGoodsSort"  Width="135"  runat="server"  ></asp:DropDownList>/
                                                                        <asp:DropDownList ID="drpValidate" runat="server" Width="120"  >
                                                                            <asp:ListItem Value="-请选择是否生效-"></asp:ListItem>
                                                                            <asp:ListItem Value="Y">是</asp:ListItem>
                                                                            <asp:ListItem Value="N">否</asp:ListItem>
                                                                        </asp:DropDownList>/	
																		<asp:DropDownList ID="drpSetIndex" Width="120" runat="server">
                                                                ...
                                                                <tr class="even gradeC">
                                                                    ...
                                                                    <td style="text-align: left">
                                                                        <asp:DropDownList ID="drpSales" runat="server" Width="200">
                                                                            <asp:ListItem Value="-是否特价促销套餐商品-"></asp:ListItem>
                                                                            <asp:ListItem Value="Y">是</asp:ListItem>
                                                                            <asp:ListItem Value="N">否</asp:ListItem>
                                                                        </asp:DropDownList>
                                                                        /	
                                                                ...
                                                                <tr class="even gradeX">
                                                                    ...
                                                                    <td style="text-align: left">
                                                                        <asp:DropDownList ID="drpExchangeGood" runat="server" Width="200">
                                                                            <asp:ListItem Value="-是否积分兑换套餐商品-"></asp:ListItem>
                                                                            <asp:ListItem Value="Y">是</asp:ListItem>
                                                                            <asp:ListItem Value="N">否</asp:ListItem>
                                                                        </asp:DropDownList>
                                                                        /	
                                                                  ...
                                                                  <tr class="even gradeC">
                                                                    ...
                                                                    <td style="text-align: left">
                                                                        <asp:DropDownList ID="drpXianGou" runat="server" Width="200">
                                                                            <asp:ListItem Value="-是否限购套餐商品-"></asp:ListItem>
                                                                            <asp:ListItem Value="Y">是</asp:ListItem>
                                                                            <asp:ListItem Value="N">否</asp:ListItem>
                                                                        </asp:DropDownList>
                                                                        /	
                                                                ...
                                                                <tr class="even gradeC">
                                                                    ...
                                                                    <td style="text-align: left">
                                                                        <div style="float: left; padding-right: 5px;">
                                                                            ...
                                                                            <br />
                                                                            <strong>允许上传套餐商品图片格式:GIF、JPG、JPEG、BMP<br />
                                                                                &nbsp;单张套餐商品图片上传不能超过4096KB(4M)</strong>
                                                                        </div>
                                                                    ...
                                                                    <td colspan="2">
                                                                        ...
                                                                        <div style="float: left; text-align: left">
                                                                            ...
                                                                            <strong>第一步：先点击浏览选择要上传的案例图片，然后点击上传按钮进行上传。<br />
                                                                                上传成功会出现提示，右边则显示出上传的套餐商品图片。<br />

                                                                                第二部：然后进行添加信息。最后点击确定，则上传套餐商品图片和信息添加成功。</strong>
                                                                        </div>
