<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsPackageManager.aspx.cs" Inherits="EnshineUnionManager.GoodsPackageManager" %>
							...
							<section id="main" class="clearfix">
								<div id="main-header" class="page-header">
									...
									<div class="widget-box">
										<h1>
											<i class="icon-zoom-in"></i>套餐商品列表查询 <span>This is the place where Search started</span>
										</h1>
										<br />
									...
									<h1>
										<i class="icon-list"></i>套餐商品信息一览 <span>This is the place where Search Result started</span>
									</h1>
								</div>
								<!--库存余量查询数据一览内容-->
								<div id="main-content">
												...
												<div class='span12 widget'>
													<div class='widget-header'>
														...
														<div style='float: right; padding-top: 4px; padding-right: 4px;'>
															<input type='button' class='btn  btn-primary' value='新套餐商品添加'
																onclick="window.location.href = 'GoodsPackageAdd.aspx?mid=<%=Request["mid"]%>'" />
														</div>
													</div>
														...
														<div class='row-fluid' style='padding-top: 2px;'>
															<div class='span12 section divScrool'>
																...
																<%--			<th>积分兑换商品</th>--%>
																	...
																	<tbody id="divShowGoodsPackageManager">
																	</tbody>
																</table>
															</div>
														</div>
