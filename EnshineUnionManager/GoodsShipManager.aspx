<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsShipManager.aspx.cs" Inherits="EnshineUnionManager.GoodsShipManager" %>
                            ...
                            <section id="main" class="clearfix">
                                <div id="main-header" class="page-header">
                                    ...
                                    <div class="widget-box">
                                        <h1>
                                            <i class="icon-zoom-in"></i>商品发货表查询 <span>This is the place where Search started</span>
                                        </h1>
                                        <br />
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td>订单编号：</td>
                                                        <td>
                                                            <input id="txtOrderNo" runat="server" width="200" class="text-info" type="text" /></td>
                                                        <td>商品名称：</td>
                                                        <td>
																																																												<input id="txtGoodsName" runat="server" width="200" class="text-info" type="text" />
                                                    ...
                                                    <tr class="odd gradeC">
                                                        ...
                                                        <td>买家姓名：</td>
                                                        <td>
                                                            <input id="txtBuyName" runat="server" width="200" class="text-info" type="text" /></td>
                                                        <td>厂家名称：</td>
                                                        <td>
																																																												<input id="txtCompany" runat="server" width="200" class="text-info" type="text" />
                                                    ...
                                                    <tr class="odd gradeX">
                                                      ...
                                                      <td>股东：</td>
                                                        <td>
                                                            <input id="txtGuDong" runat="server" width="200" class="text-info" type="text" /></td>
                                                        <td>站长：</td>
                                                        <td>
																																																												<input id="txtZhanZhang" runat="server" width="200" class="text-info" type="text" />
                                                    ...
                                                    <tr class="odd gradeC">
                                                        <td>时间选择：</td>
                                                        <td>
                                                            <input id="txtTimeSelect" runat="server" width="200" class="text-info" type="text" /></td>
                                                       <td>县域门店：</td>
                                                        <td>
                                                          	<asp:DropDownList ID="drpShopSet" runat="server"></asp:DropDownList>
                                                        </td>
                                                    ...
                                                    <tr class="odd gradeC">
                                                          <td>发货状态：</td>
                                                        <td>
                                                          	<asp:DropDownList ID="drpGoodShipStatus" runat="server">
                                                                    <asp:ListItem Value="发货状态"></asp:ListItem>
                                                        ...
                                                        <td colspan="2"> 
                                                            ...
                                                            <input type="button" class="btn btn-info" id="btnReset" runat="server"
                                                                value="清除" />
                                                            <span style="color: red">（友情提示：可选择多条件进行查询订单信息。）</span> 
																																																					</td>
                                    ...
                                    <h1>
                                        <i class="icon-list"></i>商品发货表一览 <span>This is the place where Search Result started</span>
                                    </h1>
                                </div>
                                <!--库存余量查询数据一览内容-->
                                <div id="main-content">
                                            ...
                                            <div class='row-fluid'>
                                                <div class='span12 widget'>
                                                    <div class='widget-header'>
                                                        <span class='title'>
                                                            <i class='icol-blog'></i>商品发货表信息管理					
                                                        </span>
                                                        <div style='float: right; padding-top: 4px; padding-right: 4px;'>
                                                            <input type='button' class='btn  btn-primary' value='发货确认'
                                                                id="btnGoodShipOk" />		/	  <input type='button' class='btn  btn-primary' runat="server"  	 value='导出订单' 
																				 id="btnExportExcel" onserverclick="btnExportExcel_ServerClick"		 />   
                                                            <input type="hidden" id="hfSeleckSo" />
                                                            <input type="hidden" id="hfCheckSo" />
                                                    ...
                                                    <div class='widget-content summary-list'>
                                                        <div class='row-fluid' style='padding-top: 2px;'>
                                                            <div class='span12 section divScrool'>
                                                                <table class='table table-bordered table-striped'>
                                                                    <tbody id="divShowGoodsShipManager">
                                                                    </tbody>
                                                                </table>
                                                            </div>
                                                        </div>
