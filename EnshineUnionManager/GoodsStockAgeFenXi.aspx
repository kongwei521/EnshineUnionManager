<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsStockAgeFenXi.aspx.cs" Inherits="EnshineUnionManager.GoodsStockAgeFenXi" %>
						...
						<div id="content-inner">
							...
							<section id="main" class="clearfix">
								<div id="main-header" class="page-header">
									...
									<h1>
										<i class="icon-list"></i>商品库龄分析信息一览 <span>This is the place where Search Result started</span>
									</h1>	
								</div>
								<!--库存余量查询数据一览内容-->
								<div id="main-content">
															...
															<div class='row-fluid' style='padding-top: 2px;'>
																 <div class='span12 section divScrool'>
																	  <table class='table table-bordered table-striped'>
																		   ...
																		   <tbody id="divShowGoodsStockAgeManager">
																		   </tbody>
																	  </table>
																 </div>
															</div>
