<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupBuyManager.aspx.cs" Inherits="EnshineUnionManager.GroupBuyManager" %>
...
<body>
 ...
 <div class="widget-box">
									...
									<h1>
										<i class="icon-list"></i>团购预售信息一览 <span>This is the place where Search Result started</span>
									</h1>	
								</div>
								<!--库存余量查询数据一览内容-->
								<div id="main-content">
													   ...
													   <div class='widget-header'>
															<span class='title'>
																 <i class='icol-blog'></i>团购预售信息管理
																		   ...
																		   <input type='button' class='btn  btn-primary'  value='团购预售添加' 
															...
															<div class='row-fluid' style='padding-top: 2px;'>
																 <div class='span12 section divScrool'>
																	  <table class='table table-bordered table-striped'>
																		   ...
																		   <tbody id="divShowGroupBuyManager">
																		   </tbody>
																	  </table>
																 </div>
															</div>
