<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HuoDongManager.aspx.cs" Inherits="EnshineUnionManager.HuoDongManager" %>
						...
						<div id="content-inner">
							...
							<section id="main" class="clearfix">
								<div id="main-header" class="page-header">
									...
									<h1>
										<i class="icon-list"></i>活动信息一览 <span>This is the place where Search Result started</span>
									</h1>
								</div>
								<!--库存余量查询数据一览内容-->
								<div id="main-content">
													...
													<div class='widget-header'>
														...
														<div style='float: right; padding-top: 4px; padding-right: 4px;'>
															<input type='button' class='btn  btn-primary' value='新活动添加'
																onclick="window.location.href = 'NewHuoDongAdd.aspx?mid=<%=Request["mid"]%>'" />
														</div>
														...
														<div class='row-fluid' style='padding-top: 2px;'>
															<div class='span12 section divScrool'>
																<table class='table table-bordered table-striped'>
																	...
																	<tbody id="divShowHuoDongManager">
																	</tbody>
																</table>
															</div>
														</div>
