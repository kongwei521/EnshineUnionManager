<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JoinGoodsHuoDongManager.aspx.cs" Inherits="EnshineUnionManager.JoinGoodsHuoDongManager" %>
								...
								<div id="main-header" class="page-header">
									<ul class="breadcrumb">
 									...
 									<div class="widget-box">
										<h1>
											<i class="icon-zoom-in"></i>活动信息查询 <span>This is the place where Search started</span>
										</h1>
										<br />
											...
											<table class="table table-bordered table-striped"  >
												...
												<tbody>
													<tr class="odd gradeC">
														<td >活动标题：</td>
														<td  >
															<input id="txtHuoDongTitle"   runat="server" width="200" class="text-info" type="text" /></td>
													<td >参加活动人：</td>
														<td  >
																<input id="txtJoinName"   runat="server" width="200" class="text-info" type="text" />
														 </td>
													...
													<td colspan="4">
																	...
																	&nbsp;		&nbsp;&nbsp;
														  <input type="button" class="btn btn-info" id="btnClear"   value="清除" /> 
																	 </td>
													</tr>
									...
									<h1>
										<i class="icon-list"></i>团购/预售活动信息一览 <span>This is the place where Search Result started</span>
									</h1>	
								</div>
								<!--库存余量查询数据一览内容-->
								<div id="main-content">
											 ...
											 <div class='row-fluid'>
												  <div class='span12 widget'>
													   <div class='widget-header'>
															<span class='title'>
																 <i class='icol-blog'></i>团购/预售活动信息管理
															</span>
																				  <div style='float: right; padding-top: 4px; padding-right: 4px;'> 
																		   <input type='button' class='btn  btn-primary'  value='团购/预售活动添加' 
																						onclick="window.location.href = 'GroupBuyAdd.aspx?mid=<%=Request["mid"]%>&type=<%=Request["type"]%>'" />  
            </div>
															...
															<div class='row-fluid' style='padding-top: 2px;'>
																 <div class='span12 section divScrool'>
																	  <table class='table table-bordered table-striped'>
																		   ...
																		   <tbody id="divShowJoinGoodsHuoDongInfoManager">
																		   </tbody>
																	  </table>
																 </div>
															</div>
