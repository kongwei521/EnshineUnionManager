<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberExtractReport.aspx.cs" Inherits="EnshineUnionManager.MemberExtractReport" %>
                            ...
                            <section id="main" class="clearfix">
                                <div id="main-header" class="page-header">
                                  ...
                                  <div class="widget-box">
                                        <h1>
                                            <i class="icon-zoom-in"></i>会员提现报表查询 <span>This is the place where Search started</span>
                                        </h1>
                                        <br />
                                    ...
                                    <h1>
                                        <i class="icon-list"></i>会员提现报表一览 <span>This is the place where Search Result started</span>
                                    </h1>
                                </div>
                                <!--库存余量查询数据一览内容-->
                                <div id="main-content">
