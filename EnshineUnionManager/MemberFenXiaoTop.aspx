<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberFenXiaoTop.aspx.cs" Inherits="EnshineUnionManager.MemberFenXiaoTop" %>
                    ...
                    <div id="content-outer">
                        ...
                        <section id="main" class="clearfix">
                                <div id="main-header" class="page-header">
                                    ...
                                    <h1>
                                        <i class="icon-list"></i>会员分销排行榜一览 <span>This is the place where Search Result started</span>
                                    </h1>
                                </div>
                                <!--查询条件-->
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="span6 widget">
                                            <div class="widget-header">
                                                <span class="title">
                                                    <i class="icos-abacus"></i>会员分销排行榜Top50
                                                </span>

                                            </div>
                                            <div class="widget-content task-list">
                                                <ul>
                                                     <asp:Repeater ID="rpMemberFenXiaoTopTotal" runat="server">
                                                             <ItemTemplate>
                                                                 <li>
                                                                     <table>
                                                                         <tr>
                                                                             <td style="border-right: 1px solid #f4cfcf;">
                                                                                 <label class="checkbox">
                                                                                     <span class="badge badge-success"><%#Container.ItemIndex+1 %></span>
                                                                                 </label>
                                                                             </td>
                                                                             <td></td>
