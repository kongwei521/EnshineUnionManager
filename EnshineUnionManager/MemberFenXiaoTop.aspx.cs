...
{
	public partial class MemberFenXiaoTop : System.Web.UI.Page
	{
            ...
            if (!IsPostBack)
			{
				...
				if (getCookies != null)
				{
					...
					using (EnshineUnionDataContext db = new EnshineUnionDataContext())
					{
						...
						{
							rpMemberFenXiaoTopTotal.DataSource = huiyuanfenxiaoTop.OrderByDescending(x=>x.fenxiaocount);
							rpMemberFenXiaoTopTotal.DataBind();
						}
						else
