<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyPayMoney.aspx.cs" 
	Inherits="EnshineUnionManager.MyPayMoney" %>
							...
							<section id="main" class="clearfix">
								<div id="main-header" class="page-header">
									...
									<div class="widget-box">
										<h1>
											<i class="icon-zoom-in"></i>我的收入明细 <span>This is the place where Search started</span>
										</h1>
										<br />
										<div class="widget-content nopadding">
											<table class="table table-bordered table-striped" style="width:500px;margin:0 auto">

												<tbody>
													<tr class="odd gradeX">
														<td>可提现账户余额：</td>
														<td>
													<span class="badge badge-important" id="spMoney" runat="server"></span>					元
														</td>
														<td class="auto-style1">
															<input type="text" id="txtMemberExtrac" style="  width: 80px;" runat="server" /></td>
														<td rowspan="2">
															<input type="button" class="btn btn-info" id="btnMemberExtrac"
																style="width: 80px; height: 30px;" value="提现"  runat="server"	 onserverclick="btnMemberExtrac_ServerClick"/> 
													...
													<tr class="odd gradeX">
														<td>银行账户/支付宝等;</td>
														<td colspan="2">
															<input type="text" id="txtCardNo" style="  width: 230px;" runat="server" /></td>
													</tr>
									...
									<h1>
										<i class="icon-list"></i>收入明细信息一览 <span>This is the place where Search Result started</span>
									</h1>
								</div>
								<!--库存余量查询数据一览内容-->
								<div id="main-content">
														...
														<div class='row-fluid' style='padding-top: 2px;'>
															<div class='span12 section divScrool'>
																<table class='table table-bordered table-striped'>
																	...
																	<tbody id="divShowMyPayMoneyManager">
																	</tbody>
																</table>
															</div>
														</div>
						...
						<tbody>
							<tr class="odd gradeX">
								...
								<td style="text-align: left">
									<input id="txtEditGoodsSort" runat="server" class="text-info span3" type="text" /></td>
