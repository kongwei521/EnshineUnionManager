<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyPayMoneyInfo.aspx.cs" Inherits="EnshineUnionManager.MyPayMoneyInfo" %>
						...
						<div id="content-inner">
								...
								<nav id="navigation" class="collapse">
																														<ul>
																															...
																															<li>
																																...
																																<ul class="inner-nav">
																																	<li><a href="PerfectUserInfo.aspx"><i class="icol-application-edit"></i><span class="digit">完善个人信息</span></a></li>
																																	<li><a href="UpdatePassWord.aspx"><i class="icol-ui-text-field-password"></i><span class="digit">修改个人密码</span></a></li>
																																	<li><a href="ShareLink.aspx"><i class="icol-world"></i><span class="digit">一键推广分享</span></a></li>
																																	<li><a href="MyPayMoney.aspx"><i class="icol-coins"></i>我的收入明细</a></li>
																																	<li><a href="MyPoint.aspx"><i class="icol-sum"></i>我的积分明细</a></li>
																																</ul>
																															</li>
												...
												<li><a href="CoCheckExport.aspx"><i class="icol-accept"></i>厂家核对报表</a></li>
																															...
																															<li>
																																<span title="营销中心">
																																	<i class="icon-edit"></i>
																																	<span class="nav-title">营销中心</span>
																																</span>
																																<ul class="inner-nav">
																																 ...
																																 <!--<li><a href="PlantDoctorSortManger.aspx"><i class="icol-paintbrush"></i><span class="digit">植保分类管理</span></a></li>-->
																																	...
																																	<li><a href="AdManager.aspx"><i class="icol-keyboard"></i><span class="digit">广告信息管理</span></a></li>
																															...
																															<li>
																																...
																																<ul class="inner-nav">
																																	...
																																	<li><a href="UserRecharge.aspx"><i class="icol-money-yen "></i><span class="digit">用户充值管理</span></a></li>
																																</ul>
																															</li>
																														</ul>
																													</nav>
							...
							<section id="main" class="clearfix">
								<div id="main-header" class="page-header">
									...
									<h1>
										<i class="icon-list"></i>参与活动信息一览 <span>This is the place where Search Result started</span>
									</h1>	
								</div>
								<!--库存余量查询数据一览内容-->
								<div id="main-content">
											 ...
											 <div class='row-fluid'>
												  <div class='span12 widget'>
													   <div class='widget-header'>
															<span class='title'>
																 <i class='icol-blog'></i>参与活动信息管理
															</span>
																				  <div style='float: right; padding-top: 4px; padding-right: 4px;'> 
																		   <input type='button' class='btn  btn-primary'  value='新活动添加' 
																						onclick="window.location.href = 'NewHuoDongAdd.aspx'" />  
            </div>
															...
															<div class='row-fluid' style='padding-top: 2px;'>
																 <div class='span12 section divScrool'>
																	  <table class='table table-bordered table-striped'>
																		   ...
																		   <tbody id="divShowJoinHuoDongManager">
																		   </tbody>
																	  </table>
																 </div>
															</div>
