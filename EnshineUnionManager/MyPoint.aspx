<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyPoint.aspx.cs" Inherits="EnshineUnionManager.MyPoint" %>
							...
							<section id="main" class="clearfix">
								<div id="main-header" class="page-header">
									...
									<div class="widget-box">
										<h1>
											<i class="icon-zoom-in"></i>我的积分明细 <span>This is the place where Search started</span>
										</h1>
										<br />
			 						...
			 						<table class="table table-bordered table-striped" style="width:500px;margin:0 auto">
												...
												<tbody>
													<tr class="odd gradeX">
														<td>当前积分：</td>
														<td>
													<span class="badge badge-important" id="spPoint" runat="server"></span>  分
														</td>
														<td>
															<input type="button" class="btn btn-info" id="btnGoExchange"
																style="width: 80px; height: 30px;" value="去兑换" /> 
									...
									<h1>
										<i class="icon-list"></i>积分明细信息一览 <span>This is the place where Search Result started</span>
									</h1>	
								</div>
								<!--库存余量查询数据一览内容-->
								<div id="main-content">
															...
															<div class='row-fluid' style='padding-top: 2px;'>
																 <div class='span12 section divScrool'>
																	  <table class='table table-bordered table-striped'>
																		   ...
																		   <tbody id="divShowMyPointManager">
																		   </tbody>
																	  </table>
																 </div>
															</div>
