<%@ Page Language="C#" AutoEventWireup="true"  ValidateRequest="false" CodeBehind="NewHuoDongAdd.aspx.cs" Inherits="EnshineUnionManager.NewHuoDongAdd" %>
		...
		<div id="wrapper">
							...
							<section id="main" class="clearfix">
								<div id="main-header" class="page-header">
									...
									<div class="widget-box">
										<h1>
											<i class="icon-zoom-in"></i>活动信息添加 <span>This is the place where Search started</span>
										</h1>
										<br />
											 ...
											 <div class='row-fluid'>
												  <div class='span12 widget'>
													   <div class='widget-header'>
															<span class='title'>
																 <i class='icol-blog'></i>活动信息管理
															</span>
																						  <div style='float: right; padding-top: 4px; padding-right: 4px;'> 
																		   <input type='button' class='btn  btn-primary'  value='活动列表管理' 
																						onclick="window.location.href = 'PlanManager.aspx?mid=<%=Request["mid"]%>'" />  
                       </div>
													   </div>
											...
											<table class="table table-bordered table-striped">
												<tbody>
													<tr class="odd gradeX">
																	<td  style="width:120px;">活动标题：</td>
														<td colspan="3" style="text-align:left"   >	
																			<input id="txtTitle" runat="server"  class="span10" type="text" />
														 </td>
													</tr>
            ...
            <tr class="even gradeX" >  	
														...
														<td style="text-align:left"   >	
															<input id="txtTimeSelect" runat="server"   style="  width: 320px;" type="text" /></td>
																	   	<td  style="width:120px;">发布者：</td>
														<td style="text-align:left"  >
														 <input id="txtPeople" runat="server" class="span10"  type="text" />
															  </td>
													</tr>
														<tr class="odd gradeC">	<td> 关键词：</td>
														<td   style="text-align:left"   >							 
												 
																<textarea id="txtKeyWord" runat="server" style="width: 400px; height: 50px;"></textarea>
															</td>
																	<td>是否首页显示 ：</td>
															<td>
														...
														<tr class="odd gradeX">	<td> 活动分类;</td>
														<td   style="text-align:left"   >							 
												 				<asp:DropDownList ID="drpHuoDongSort" Width="200" runat="server">
																		</asp:DropDownList>
																		</td>
													</tr>
													<tr class="odd gradeC">							<td> 活动内容：</td>
														<td colspan="3" style="text-align:left"   >							 
														<textarea id="txtFckContent" runat="server" style="width: 670px; height: 250px;"></textarea>
															</td>
													</tr>
									
											<tr class="odd gradeX">
																<td style="width:85px">活动图片：</td>
														<td   style="text-align:left"   >	
															...
															<br /><strong>允许上传活动图片格式:GIF、JPG、JPEG、BMP<br />
											&nbsp;单张活动图片上传不能超过4096KB(4M)</strong>		<br />	 <br />	 
														<span style="color:red;font-weight:bold">友情提示：	</span>									 <br />
															<strong>第一步：先点击浏览选择要上传的活动图片，然后点击上传按钮进行上传。<br />	 上传成功会出现提示，右边则显示出上传的活动图片。<br />
											<br />
											第二部：然后进行添加信息。最后点击确定，则上传活动图片和信息添加成功。</strong>
														</td>
														<td  >预览活动图片:</td>
									   <td><img  id="iShowPhoto" src="~/assets/images/nophoto.gif"
													...
													<td colspan="4">
															...
															<asp:Button ID="btnAddHuoDong"  Width="80"  CssClass="btn btn-info" Text="添加" runat="server"  OnClick="btnAddHuoDong_Click" />					

														 &nbsp;&nbsp;&nbsp;			
														<asp:HiddenField ID="hfDel" runat="server" />
															<asp:Button ID="btnUpdateHuoDong" Width="80"   CssClass="btn btn-info" Text="修改" runat="server"  OnClick="btnUpdateHuoDong_Click"/>					
																			 &nbsp;&nbsp;&nbsp;	
