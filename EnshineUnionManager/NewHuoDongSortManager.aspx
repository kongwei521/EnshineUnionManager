<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewHuoDongSortManager.aspx.cs" Inherits="EnshineUnionManager.NewHuoDongSortManager" %>
		...
		<div id="wrapper">
							...
							<section id="main" class="clearfix">
								<div id="main-header" class="page-header">
									...
									<div class="widget-box">
										<h1>
											<i class="icon-zoom-in"></i>活动分类添加 <span>This is the place where Search started</span>
										</h1>
										<br />
											...
											<table class="table table-bordered table-striped">
												...
												<tbody>
													<tr class="odd gradeX">
														<td>活动分类名称：</td>
														<td>
															<input id="txtHuoDongSort" runat="server" width="200" class="text-info" type="text" /></td>
														<td>
															<input type="button" class="btn btn-info" id="btnAddHuoDongSort"
									...
									<h1>
										<i class="icon-list"></i>活动分类信息一览 <span>This is the place where Search Result started</span>
									</h1>
								</div>
								<!--库存余量查询数据一览内容-->
								<div id="main-content">
														...
														<div class='row-fluid' style='padding-top: 2px;'>
															<div class='span12 section divScrool'>
																<table class='table table-bordered table-striped'>
																	...
																	<tbody id="divShowHuoDongSortManager">
																	</tbody>
																</table>
															</div>
														</div>
			...
			<div id="anim-modal" class="modal fade hide" data-backdrop="static" style="width: 500px;">
						...
						<tbody>
							<tr class="odd gradeX">
								...
								<td style="text-align: left">
									<input id="txtEditHuoDongSort" runat="server" class="text-info span3" type="text" /></td>
								<input type="hidden" class="text-info" id="hfHuoDongSortId" />
							</tr>
				...
				<div class="modal-footer">
					<input type="button" class="btn btn-danger" id="btnEditHuoDongSort"
						style="width: 60px; height: 28px;" value="修改" />&nbsp;&nbsp;&nbsp;
															<input type="button" class="btn btn-danger" id="btnResetHuoDongSort"
