<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsCommentManager.aspx.cs" Inherits="EnshineUnionManager.NewsCommentManager" %>
						...
						<div id="content-inner">
							...
							<section id="main" class="clearfix">
								<div id="main-header" class="page-header">
									...
									<h1>
										<i class="icon-list"></i>新闻评论信息一览 <span>This is the place where Search Result started</span>
									</h1>	
								</div>
								<!--库存余量查询数据一览内容-->
								<div id="main-content">
											 ...
											 <div class='row-fluid'>
												  <div class='span12 widget'>
													   <div class='widget-header'>
															<span class='title'>
																 <i class='icol-blog'></i>新闻评论信息管理
															</span>
																						  <div style='float: right; padding-top: 4px; padding-right: 4px;'> 
																		   <input type='button' class='btn  btn-primary'  value='新闻/公告添加' onclick="window.location.href = 'NewsNoticesAdd.aspx?mid=<%=Request["mid"]%>'" />  
                                                                       </div>
													   </div>
															...
															<div class='row-fluid' style='padding-top: 2px;'>
																 <div class='span12 section divScrool'>
																	  <table class='table table-bordered table-striped'>
																		   ...
																		   <tbody id="divShowNewsCommentManager">
																		   </tbody>
																	  </table>
																 </div>
															</div>
