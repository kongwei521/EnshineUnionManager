<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsSortManager.aspx.cs" Inherits="EnshineUnionManager.NewsSortManager" %>
		...
		<div id="wrapper">
							...
							<section id="main" class="clearfix">
								<div id="main-header" class="page-header">
									...
									<div class="widget-box">
										<h1>
											<i class="icon-zoom-in"></i>新闻分类添加 <span>This is the place where Search started</span>
										</h1>
										<br />
											...
											<table class="table table-bordered table-striped">
												...
												<tbody>
													<tr class="odd gradeX">
														<td>新闻分类名称：</td>
														<td>
															<input id="txtNewsSort" runat="server" width="200" class="text-info" type="text" /></td>
														<td>
															<input type="button" class="btn btn-info" id="btnAddNewsSort"
									...
									<h1>
										<i class="icon-list"></i>新闻分类信息一览 <span>This is the place where Search Result started</span>
									</h1>
								</div>
								<!--库存余量查询数据一览内容-->
								<div id="main-content">
														...
														<div class='row-fluid' style='padding-top: 2px;'>
															<div class='span12 section divScrool'>
																<table class='table table-bordered table-striped'>
																	...
																	<tbody id="divShowNewsSortManager">
																	</tbody>
																</table>
															</div>
														</div>
			...
			<div id="anim-modal" class="modal fade hide" data-backdrop="static" style="width: 500px;margin:0 auto">
						...
						<tbody>
							<tr class="odd gradeX">
								...
								<td style="text-align: left">
									<input id="txtEditNewsSort" runat="server" class="text-info span3" type="text" /></td>
								<input type="hidden" class="text-info" id="hfNewsSortId" />
							</tr>
				...
				<div class="modal-footer">
					<input type="button" class="btn btn-danger" id="btnEditNewsSort"
						style="width: 60px; height: 28px;" value="修改" />&nbsp;&nbsp;&nbsp;
															<input type="button" class="btn btn-danger" id="btnResetNewsSort"
