<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlantDoctorManager.aspx.cs" Inherits="EnshineUnionManager.PlantDoctorManager" %>
						...
						<div id="content-inner">
							...
							<section id="main" class="clearfix">
								<div id="main-header" class="page-header">
									...
									<h1>
										<i class="icon-list"></i>植保医院信息一览 <span>This is the place where Search Result started</span>
									</h1>	
								</div>
								<!--库存余量查询数据一览内容-->
								<div id="main-content">
													   ...
													   <div class='widget-header'>
															<span class='title'>
																 <i class='icol-blog'></i>植保医院信息管理
																		   ...
																		   <input type='button' class='btn  btn-primary'  value='植保医院添加' onclick="window.location.href = 'PlantDoctorAdd.aspx'" />  
                                                                       </div>
													   </div>
															...
															<div class='row-fluid' style='padding-top: 2px;'>
																 <div class='span12 section divScrool'>
																	  <table class='table table-bordered table-striped'>
																		   ...
																		   <tbody id="divShowPlantDoctorManager">
																		   </tbody>
																	  </table>
																 </div>
															</div>
