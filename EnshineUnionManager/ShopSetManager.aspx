<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopSetManager.aspx.cs" Inherits="EnshineUnionManager.ShopSetManager" %>
		...
		<div id="wrapper">
											...
											<ul class="inner-nav">
											 ...
											 <!--<li><a href="PlantDoctorSortManger.aspx"><i class="icol-paintbrush"></i><span class="digit">植保分类管理</span></a></li>-->
												...
												<li><a href="MemberManager.aspx"><i class="icol-cog"></i>会员设置管理</a></li>
													<li class="active"><a href="ShopSetManager.aspx"><i class="icol-nuclear"></i>门店店铺管理</a></li>
							...
							<section id="main" class="clearfix">
								<div id="main-header" class="page-header">
									...
									<div class="widget-box">
										<h1>
											<i class="icon-zoom-in"></i>店铺设置添加 <span>This is the place where Search started</span>
										</h1>
										<br />
											...
											<table class="table table-bordered table-striped">
												...
												<tbody>
													<tr class="odd gradeX">
														<td>门店名称：</td>
														<td>
															<input id="txtShopName" runat="server" width="200" class="text-info" type="text" /></td>
														<td rowspan="2">
															<input type="button" class="btn btn-info" id="btnAddShop"
													...
													<tr class="odd gradeX">
														<td>店铺联系方式：</td>
														<td>
														<input id="txtShopTel" runat="server" width="200" class="text-info" type="text" /></td>
													</tr>
									...
									<h1>
										店铺设置信息一览 <span>This is the place where Search Result started</span>
									</h1>
								</div>
								<!--库存余量查询数据一览内容-->
								<div id="main-content">
			...
			<div id="anim-modal" class="modal fade hide" data-backdrop="static" style="width: 500px;">
						...
						<tbody>
							<tr class="odd gradeX">
								...
								<td style="text-align: left">
									<input id="txtEditShopName" runat="server" class="text-info span3" type="text" /></td>
								<input type="hidden" class="text-info" id="hfShopId" />
							</tr>
									<tr class="odd gradeX">
								<td>店铺联系方式：</td>
								<td style="text-align: left">
									<input id="txtEditTel" runat="server" class="text-info span3" type="text" /></td>
				...
				<div class="modal-footer">
					<input type="button" class="btn btn-danger" id="btnEditShop"
						style="width: 60px; height: 28px;" value="修改" />&nbsp;&nbsp;&nbsp;
															<input type="button" class="btn btn-danger" id="btnResetShop"
