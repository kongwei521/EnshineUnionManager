<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserExtractMoenyManager.aspx.cs" Inherits="EnshineUnionManager.UserExtractMoenyManager" %>
                        ...
                        <div id="content-inner">
                            ...
                            <section id="main" class="clearfix">
                                <div id="main-header" class="page-header">
                                    ...
                                    <h1>
                                        <i class="icon-list"></i>会员提现管理一览 <span>This is the place where Search Result started</span>
                                    </h1>
                                </div>
                                <!--库存余量查询数据一览内容-->
                                <div id="main-content">
                                            ...
                                            <div class='row-fluid'>
                                                <div class='span12 widget'>
                                                    <div class='widget-header'>
                                                        <span class='title'>
                                                            <i class='icol-blog'></i>会员提现管理					
                                                        </span>
                                                        <div style='float: right; padding-top: 4px; padding-right: 4px;'>
                                                            <input type='button' class='btn  btn-primary' value='生成提现清单'
                                                                id="btnExtractOk" />
                                                            <input type="hidden" id="hfSeleckExtNo" />
                                                            <input type="hidden" id="hfCheckExtNo" />
                                                        ...
                                                        <div class='row-fluid' style='padding-top: 2px;'>
                                                            <div class='span12 section divScrool'>
                                                                <table class='table table-bordered table-striped'>
                                                                    <tbody id="divShowExtractListManager">
                                                                    </tbody>
                                                                </table>
                                                            </div>
                                                        </div>
