<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserInfoManager.aspx.cs" Inherits="EnshineUnionManager.UserInfoManager" %>
							...
							<section id="main" class="clearfix">
								<div id="main-header" class="page-header">
									<ul class="breadcrumb">
										...
										<h1>
											<i class="icon-zoom-in"></i>用户信息查询 <span>This is the place where Search started</span>
										</h1>
										<br />
											...
											<table class="table table-bordered table-striped"  >
												...
												<tbody>
													<tr class="odd gradeC">
														<td >昵称：</td>
														<td  >
															<input id="txtNickName"   runat="server" width="200" class="text-info" type="text" /></td>
													<td >姓名：</td>
														<td  >
															<input id="txtName"   runat="server" width="200" class="text-info" type="text" /></td>
										 
													</tr>
														<tr class="odd gradeX">
														<td >邀请码：</td>
														<td  >
															<input id="txtInvitedcode"   runat="server" width="200" class="text-info" type="text" /></td>
																	<%--				<td >审核状态：</td>
														<td  >
												<asp:DropDownList ID="drpActive" runat="server">
																<asp:ListItem>-请选择审核状态-</asp:ListItem>
																<asp:ListItem Value="Y">已审核</asp:ListItem>
																<asp:ListItem Value="N">未审核</asp:ListItem>
															</asp:DropDownList>	</td>--%>
																		<td colspan="2">
																		  <input type="button" class="btn btn-info" id="btnSearch"   value="查询" /> 				&nbsp;		&nbsp;&nbsp;
														  <input type="button" class="btn btn-info" id="btnReset"   value="清除" /> 
																	 </td>
									...
									<h1>
										<i class="icon-list"></i>用户信息一览 <span>This is the place where Search Result started</span>
											 ...
											 <div class='row-fluid'>
												  <div class='span12 widget'>
													   <div class='widget-header'>
															<span class='title'>
																 <i class='icol-blog'></i>用户信息管理
															</span>
																			  <div style='float: right; padding-top: 4px; padding-right: 4px;'> 
																		   <input type='button' class='btn  btn-primary'  value='新用户添加' 
																						onclick="window.location.href = 'PerfectUserInfo.aspx?mid=<%=Request["mid"]%>'" />  
                                                                                 </div> 
													   </div>
															...
															<div class='row-fluid' style='padding-top: 2px;'>
																 <div class='span12 section divScrool'>
																	  <table class='table table-bordered table-striped'>
																		   ...
																		   <tbody id="divShowUserInfoManager">
																		   </tbody>
																	  </table>
																 </div>
															</div>
