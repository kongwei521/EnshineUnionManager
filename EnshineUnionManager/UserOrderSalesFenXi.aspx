<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserOrderSalesFenXi.aspx.cs" Inherits="EnshineUnionManager.UserOrderSalesFenXi" %>
						...
						<div id="content-inner">
							...
							<section id="main" class="clearfix">
								<div id="main-header" class="page-header">
									...
									<h1>
										<i class="icon-list"></i>用户消费分析信息一览 <span>This is the place where Search Result started</span>
									</h1>	
								</div>
								<!--库存余量查询数据一览内容-->
								<div id="main-content">
											 ...
											 <div class='row-fluid'>
												  <div class='span12 widget'>
													   <div class='widget-header'>
															<span class='title'>
																 <i class='icol-blog'></i>用户消费分析信息统计
															</span>
															...
															<div class='row-fluid' style='padding-top: 2px;'>
																 <div class='span12 section divScrool'>
																	  <table class='table table-bordered table-striped'>
																		   ...
																		   <tbody id="divShowUserOrderSalesFenXiManager">
																		   </tbody>
																	  </table>
																 </div>
															</div>
