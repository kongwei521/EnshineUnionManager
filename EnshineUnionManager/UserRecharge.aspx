<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserRecharge.aspx.cs" Inherits="EnshineUnionManager.UserRecharge" %>
							...
							<section id="main" class="clearfix">
								<div id="main-header" class="page-header">
									...
									<div class="widget-box">
										<h1>
											<i class="icon-zoom-in"></i>交易记录列表查询 <span>This is the place where Search started</span>
										</h1>
										<br />
											...
											<table class="table table-bordered table-striped" style="width: auto; margin: 0 auto">
												...
												<tbody>
													<tr class="odd gradeX">
														...
														<td>充值手机：</td>
														<td>
															<input id="txtRechargeTel" runat="server" width="200" class="text-info" type="text" /></td>
														<td>交易状态：</td>
														<td>

															<asp:DropDownList ID="drpRechargeStatus" runat="server">
																<asp:ListItem Value="交易状态">交易状态</asp:ListItem>
																<asp:ListItem Value="Y">交易成功</asp:ListItem>
																<asp:ListItem Value="N">交易失败</asp:ListItem>
													<%--			<asp:ListItem Value="S">分红成功</asp:ListItem>--%>
                                                                <asp:ListItem Value="C">撤销充值</asp:ListItem>
															</asp:DropDownList>
														</td>
													</tr>
													<tr class="odd gradeC">
									...
									<h1>
										<i class="icon-list"></i>交易记录列表一览 <span>This is the place where Search Result started</span>
									</h1>
								</div>
								<!--库存余量查询数据一览内容-->
								<div id="main-content">
											...
											<div class='row-fluid'>
												<div class='span12 widget'>
													<div class='widget-header'>
														<span class='title'>
															<i class='icol-money'></i>交易记录信息管理					
														</span>
														<div style='float: right; padding-top: 4px; padding-right: 4px;'>
                                                             <input type='button' class='btn  btn-primary'  value='用户充值' onclick="window.location.href = 'UserRechargeAdd.aspx'" />  

														 <%--<input type='button' class='btn  btn-primary' value='导出Excel'
																id="btnExportExcel"  runat="server" onserverclick="btnExportExcel_ServerClick"/>
										 --%>
														</div>
														...
														<div class='row-fluid' style='padding-top: 2px;'>
															<div class='span12 section divScrool'>
																<table class='table table-bordered table-striped'>
																	...
																	<tbody id="divShowUserRechargeManager">
																	</tbody>
																</table>
															</div>
														</div>
