<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserRoleManager.aspx.cs" Inherits="EnshineUnionManager.UserRoleManager" %>
						...
						<div id="content-inner">
							...
							<section id="main" class="clearfix">
								<div id="main-header" class="page-header">
									...
									<h1>
										<i class="icon-list"></i>角色列表一览 <span>This is the place where Search Result started</span>
									</h1>
								</div>
								<!--库存余量查询数据一览内容-->
								<div id="main-content">
											...
											<div class='row-fluid'>
												<div class='span12 widget'>
													<div class='widget-header'>
														<span class='title'>
															<i class='icol-blog'></i>角色列表管理
														</span>
																				    <div style='float: right; padding-top: 4px; padding-right: 4px;'>
                                                            <input type='button' class='btn  btn-primary' value='角色添加'
                                                                onclick="window.location.href = 'UserRoleSet.aspx?mid=<%=Request["mid"]%>'" />
                                                        </div>
													</div>
